...
/* Name of the members who have issued a book and such that book supplier belongs to PUNE/MUMBAI/DELHI*/===DONE
...
/* Name of the members who have issued a book later than 01-01-2014*/
...
where lms_members.date_register > '01-01-1999';
...
--Rakesh
select distinct A.member_name, A.membership_status 
from lms_book_issue B 
inner join lms_fine_details E 
on (B.Fine_Range = E.Fine_Range and E.Fine_Amount > 74)
inner join lms_book_details C 
on (B.book_code = C.book_code)
inner join lms_suppliers_details D
on (C.supplier_id = D.supplier_id and D.email like '%gmail%')
