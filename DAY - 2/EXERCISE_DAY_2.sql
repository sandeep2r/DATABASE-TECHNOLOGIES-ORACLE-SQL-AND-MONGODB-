...
--QUESTION--SUPPLIER NAME OF ALL SUPPLIERS WHOSE ADDRESS IS'MUMBAI'
...
--QUESTION--NAMES FO THE MEMEBERS WHO STAY IN CITY PUNE

SELECT MEMBER_NAME
FROM LMS_MEMBERS
WHERE LOWER(CITY) = 'pune';
--lower(city) give output where city name written PUNE and pune
...
--QUESTION--NAMES OF THE MEMEBERS AND DATE FO REGISTRATION WHO STAY IN CITY(PUNE/MUMBAI/BANGLORE)
 SELECT MEMBER_NAME,DATE_REGISTER
 FROM LMS_MEMBERS
 WHERE LOWER(CITY) IN ('pune','mumbai','bangalore');
 
 --OUTPUT
 --MEMEBER_NAME--DATE-REGISTER
--Amruta	    02-MAR-20
--Gautam	    12-JUN-18
--Mayur	        19-SEP-19
--Nikhil	    09-MAR-20
...
--QUESTION--NAME OF THE BOOKS WHO BELONG TO CATEGORY JAVA AND AUTHOR IS "PAUL J. DEITEL
SELECT BOOK_TITLE
FROM LMS_BOOK_DETAILS
...
--QUESTION--MEMEBER ID AND BOOK CODE OF ALL ISSUANCES THAT HAVE NOT PAID ANY FINE
